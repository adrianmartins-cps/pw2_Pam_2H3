...
export name='adrianmartins-cps'
export email="adrian.silva64@etec.sp.gov.br"
export repositorio="https://github.com/adrianmartins-cps/pw2_Pam_2H3.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aula-$(date +%Y%m%d%H%M%S)"
